                    ...
                    <div class="portlet-body">
                        <div class="clearfix">
                            ...
                            <div id="update" class="btn-group">
                                <a href="Goodsfunction/EditGood.jsp?active=menupage6_0" type="button" class="btn green">修改商品 <i class="icon-edit"></i>
                                </a>
                            </div>                            
            ...
            success: function (result) {            	
                if (result.code == 1) {
                    ...
                    for (var i = 0; i < data.length; i++) {     
                        ...
                        html += '<td class="hidden-480"><a href="./Goods/EditGood?CID=' + data[i].CID + '&active=menupage6_0" class="label label-important" style="color: white;">编辑</a></td></tr>';
