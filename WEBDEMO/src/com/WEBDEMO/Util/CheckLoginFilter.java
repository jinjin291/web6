...
public class CheckLoginFilter implements Filter { 
	 ...
	 // ArrayList<User> list=(ArrayList)session.getAttribute(sessionKey);
	  User list=(User) session.getAttribute(sessionKey);
	  if(sessionKey==null) 
	  { 
	   filterChain.doFilter(request, response); 
	   return; 
	  } 
	  if((!checkRequestURIIntNotFilterList(request)) && (list == null)) 
	  { 
